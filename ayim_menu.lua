...
Menu.Banner = {
    enabled = true,
    imageUrl = "https://i.imgur.com/Sy9Zl6L.png",
    height = 100
}
...
Menu.Colors = {
    HeaderPink = { r = 4, g = 74, b = 224 },
    SelectedBg = { r = 4, g = 74, b = 224 },
    TextWhite = { r = 255, g = 255, b = 255 },
    BackgroundDark = { r = 0, g = 0, b = 0 },
    FooterBlack = { r = 0, g = 0, b = 0 }
}

Menu.CurrentTheme = "Blue (default)"
...
function Menu.ApplyTheme(themeName)
    ...
    if themeLower == "blue (default)" then
        Menu.Colors.HeaderPink = { r = 4, g = 74, b = 224 }
        Menu.Colors.SelectedBg = { r = 4, g = 74, b = 224 }
        Menu.Banner.imageUrl = "https://i.imgur.com/Sy9Zl6L.png"
        Menu.CurrentTheme = "Blue (default)"
    elseif themeLower == "arabian drift" then
        Menu.Colors.HeaderPink = { r = 138, g = 135, b = 107 }
        Menu.Colors.SelectedBg = { r = 138, g = 135, b = 107 }
        Menu.Banner.imageUrl = "https://i.imgur.com/jm4e6DN.png"
        Menu.CurrentTheme = "Arabian Drift"
    elseif themeLower == "basmala" then
        Menu.Colors.HeaderPink = { r = 128, g = 128, b = 128 }
        Menu.Colors.SelectedBg = { r = 128, g = 128, b = 128 }
        Menu.Banner.imageUrl = "https://i.imgur.com/ZSh5Kqq.png"
        Menu.CurrentTheme = "Basmala"
    elseif themeLower == "cat" then
        Menu.Colors.HeaderPink = { r = 255, g = 20, b = 147 }
        Menu.Colors.SelectedBg = { r = 255, g = 20, b = 147 }
        Menu.Banner.imageUrl = "https://i.imgur.com/nvtd4Rt.jpeg"
        Menu.CurrentTheme = "Cat"
    elseif themeLower == "phuket" then
        Menu.Colors.HeaderPink = { r = 235, g = 242, b = 97 }
        Menu.Colors.SelectedBg = { r = 235, g = 242, b = 97 }
        Menu.Banner.imageUrl = "https://i.imgur.com/k2HHLit.png"
        Menu.CurrentTheme = "Phuket"
    elseif themeLower == "ayim" then
        Menu.Colors.HeaderPink = { r = 4, g = 74, b = 224 }
        Menu.Colors.SelectedBg = { r = 4, g = 74, b = 224 }
        Menu.Banner.imageUrl = "https://i.imgur.com/JJ6rbL1.png"
        Menu.CurrentTheme = "Ayim"
    else
        Menu.Colors.HeaderPink = { r = 4, g = 74, b = 224 }
        Menu.Colors.SelectedBg = { r = 4, g = 74, b = 224 }
        Menu.Banner.imageUrl = "https://i.imgur.com/jm4e6DN.png"
...
function Menu.DrawHeader()
    ...
    if Menu.Banner.enabled then
        if Menu.bannerTexture and Menu.bannerTexture > 0 and Susano and Susano.DrawImage then
            Susano.DrawImage(Menu.bannerTexture, x, y, width, bannerHeight, 1, 1, 1, 1, radius)
        else
...
function Menu.DrawScrollbar(x, startY, visibleHeight, selectedIndex, totalItems, isMainMenu, menuWidth)
    ...
    local thumbHeight = scrollbarHeightibles
    local thumbY
...
function Menu.DrawBottomRoundedRect(x, y, width, height, r, g, b, a, radius)
    Menu.DrawRect(x, y, width, height - radius, r, g, b, a)
    Menu.DrawRect(x + radius, y + height - radius, width - 2 * radius, radius, r, g, b, a)

    for i = 0, radius - 1 do
        local slice_width = math.ceil(math.sqrt(radius * radius - i * i))
        local y_pos = y + height - radius + i
...
function Menu.DrawFooter()
    ...
    -- Barre séparatrice colorée selon le thème
    ...
    if Susano and Susano.DrawRectFilled then
        Susano.DrawRectFilled(x, separatorY, scaledPos.width - 1, separatorHeight, separatorR, separatorG, separatorB, 1.0, 0)
    else
        Menu.DrawRect(x, separatorY, scaledPos.width - 1, separatorHeight, Menu.Colors.SelectedBg.r, Menu.Colors.SelectedBg.g, Menu.Colors.SelectedBg.b, 255)
    end
    ...
    if Susano and Susano.DrawRectFilled then
        -- Susano ne supporte pas les coins arrondis uniquement en bas, on utilise notre fonction
